...
Surface::Surface()
{
    ...
    controlPoints[0][1] = glm::vec3(-1.5f, -0.5f, 0.0f);
    controlPoints[0][2] = glm::vec3(-1.5f, 0.5f, 0.0f);
    controlPoints[0][3] = glm::vec3(-1.5f, 1.5f, 0.0f);

    controlPoints[1][0] = glm::vec3(-0.5f, -1.5f, 0.0f);
    controlPoints[1][1] = glm::vec3(-0.5f, -0.5f, 1.0f);
    controlPoints[1][2] = glm::vec3(-0.5f, 0.5f, 1.0f);
    controlPoints[1][3] = glm::vec3(-0.5f, 1.5f, 0.0f);

    controlPoints[2][0] = glm::vec3(0.5f, -1.5f, 0.0f);
    controlPoints[2][1] = glm::vec3(0.5f, -0.5f, 1.0f);
    controlPoints[2][2] = glm::vec3(0.5f, 0.5f, 1.0f);
    controlPoints[2][3] = glm::vec3(0.5f, 1.5f, 0.0f);

    controlPoints[3][0] = glm::vec3(1.5f, -1.5f, 0.0f);
    controlPoints[3][1] = glm::vec3(1.5f, -0.5f, 0.0f);
    controlPoints[3][2] = glm::vec3(1.5f, 0.5f, 0.0f);
    controlPoints[3][3] = glm::vec3(1.5f, 1.5f, 0.0f);


    controlPoints[4][0] = glm::vec3(2.5f, -1.5f, 0.0f);
    controlPoints[4][1] = glm::vec3(2.5f, -0.5f, 0.0f);
    controlPoints[4][2] = glm::vec3(2.5f, 0.5f, 0.0f);
    controlPoints[4][3] = glm::vec3(2.5f, 1.5f, 0.0f);

    controlPoints[0][4] = glm::vec3(-1.5f, 2.5f, 0.0f);
    controlPoints[1][4] = glm::vec3(-0.5f, 2.5f, 0.0f);
    controlPoints[2][4] = glm::vec3(0.5f, 2.5f, 0.0f);
    controlPoints[3][4] = glm::vec3(1.5f, 2.5f, 0.0f);
